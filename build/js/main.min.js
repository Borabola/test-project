...
Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_8__["initAccordion"])();
...
/*!**************************************!*\
  !*** ./js/modules/init-accordion.js ***!
  \**************************************/
/*! exports provided: initAccordion, updateActiveAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAccordion", function() { return initAccordion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateActiveAccordion", function() { return updateActiveAccordion; });
...
var initAccordionAction = function initAccordionAction(accordion) {
  ...
  btn.addEventListener('click', function (e) {
    e.preventDefault();
    btn.blur();
    var activeAccordionBtn = document.querySelector('.accordion__btn.active');

    if (activeAccordionBtn && activeAccordionBtn !== btn) {
      var activeAccordion = activeAccordionBtn.closest('.accordion');
      var activeAccordionContent = activeAccordion.querySelector('.accordion__content');
